                    ...
                    <form method="POST" action="{{ route($routeIndex . '.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control @error('price') {{'is-invalid'}} @enderror" id="inputPrice" aria-describedby="price" name="price" value="{{old('price')}}" placeholder="Harga Produk" aria-describedby="priceAddon">
                            </div>
                            @error('price')
                                <div class="form-text text-danger">*{{$message}}</div>
                            @enderror
